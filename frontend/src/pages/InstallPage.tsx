...
export default function InstallPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <h1 className="text-2xl font-extrabold tracking-tight text-body sm:text-3xl">Instalar la aplicación</h1>
      ...
      <div className="mt-6 space-y-4">
        <InstallGuide />
        <div className="card">
          <h3 className="mb-2 font-bold text-body">Después de instalar</h3>
          <ActivateAlerts />
        </div>
        <div className="card">
          <h3 className="mb-2 font-bold text-body">Requisitos para recibir notificaciones</h3>
          <ul className="list-disc space-y-1.5 pl-5 text-sm text-body-muted">
