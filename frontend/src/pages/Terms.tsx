...
export default function Terms() {
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-10">
      <h1 className="text-2xl font-extrabold tracking-tight text-body sm:text-3xl">Términos de uso</h1>

      <section className="card">
        <h2 className="font-bold text-body">Naturaleza del servicio</h2>
        ...
        <p className="mt-3 rounded-lg border border-sev-moderate/30 bg-sev-moderate/10 p-3 text-sm text-sev-moderate">
          {DISCLAIMER_TEXT}
        </p>
      </section>

      <section className="card">
        <h2 className="font-bold text-body">Factores que afectan las alertas</h2>
        <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-body-muted">
      ...
      <section className="card">
        <h2 className="font-bold text-body">Uso aceptable</h2>
        <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-body-muted">
      ...
      <section className="card">
        <h2 className="font-bold text-body">Datos de demostración</h2>
        <p className="mt-2 text-sm text-body-muted">
      ...
      <section className="card">
        <h2 className="font-bold text-body">Cambios en los términos</h2>
        <p className="mt-2 text-sm text-body-muted">
