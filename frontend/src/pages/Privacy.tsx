export default function Privacy() {
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-10">
      <h1 className="text-2xl font-extrabold tracking-tight text-body sm:text-3xl">Política de privacidad</h1>

      <section className="card">
        <h2 className="font-bold text-body">Qué datos guardamos</h2>
      ...
      <section className="card">
        <h2 className="font-bold text-body">Qué NO hacemos</h2>
        <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-body-muted">
      ...
      <section className="card">
        <h2 className="font-bold text-body">Tus derechos</h2>
        <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-body-muted">
      ...
      <section className="card">
        <h2 className="font-bold text-body">Datos de eventos sísmicos</h2>
